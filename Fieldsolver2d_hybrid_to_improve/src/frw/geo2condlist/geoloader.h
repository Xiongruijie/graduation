...
class GDS{//the region of the FRW solution
public:
...
class BoundStatic{
    public:
    static Boundary zone;
};
Boundary BoundStatic::zone=Boundary();

typedef std::vector<std::vector<float> > Matrix_frw;
